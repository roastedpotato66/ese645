...
from src.utils.image_utils import get_word_inds, get_time_words_attention_alpha
from src.models.p2p import seq_aligner
...
class LocalBlend:
    ...
    def __call__(self, x_t, attention_store):
        self.counter += 1
        if not attention_store or "down_cross" not in attention_store or "up_cross" not in attention_store:
            return x_t
